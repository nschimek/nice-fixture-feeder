...
func (_m *MockLeagueRequest) GetData() []model.League {
	ret := _m.Called()
...
// MockLeagueRequest_GetData_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetData'
type MockLeagueRequest_GetData_Call struct {
	*mock.Call
}

// GetData is a helper method to define mock.On call
func (_e *MockLeagueRequest_Expecter) GetData() *MockLeagueRequest_GetData_Call {
	return &MockLeagueRequest_GetData_Call{Call: _e.mock.On("GetData")}
}

func (_c *MockLeagueRequest_GetData_Call) Run(run func()) *MockLeagueRequest_GetData_Call {
...
func (_c *MockLeagueRequest_GetData_Call) Return(_a0 []model.League) *MockLeagueRequest_GetData_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockLeagueRequest_GetData_Call) RunAndReturn(run func() []model.League) *MockLeagueRequest_GetData_Call {
	_c.Call.Return(run)
	return _c
}
